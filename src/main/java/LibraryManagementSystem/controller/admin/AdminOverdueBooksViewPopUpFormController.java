...
public class AdminOverdueBooksViewPopUpFormController implements Initializable {
    ...
    public void allOverDueBooks() {
        ...
        TransactionDto dto = transactionService
                .getTransactionData(AdminOverdueBorrowersBarFormController.transactionId);
    ...
    private void loadDataTable(int id) {
        try {
            FXMLLoader loader = new FXMLLoader(AdminOverdueBooksViewPopUpFormController.class.getResource("/view/adminOverdueBooksViewPopUpBarForm.fxml"));
            Parent root = loader.load();
            AdminOverdueBooksViewPopUpBarFormController controller = loader.getController();
